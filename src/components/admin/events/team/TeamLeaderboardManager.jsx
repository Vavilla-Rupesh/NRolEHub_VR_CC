...
export default function TeamLeaderboardManager() {
  ...
  // Check if winners have been declared (filter out entries with no team_id or invalid data)
  const validWinners = leaderboard.filter(
    (entry) => entry.team_id && entry.Team && entry.score !== null && entry.score !== undefined
  );
    ...
    <div className="min-h-screen from-slate-50 via-purple-50 to-blue-50 dark:from-slate-900 dark:via-purple-900 dark:to-slate-900">
      ...
      <div className="relative space-y-8 p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto">
        ...
        {editMode ? (
          ...
          // No Winners Declared State
          <div className="backdrop-blur-xl bg-white/70 dark:bg-black/30 border border-white/20 dark:border-gray-700/50 rounded-3xl p-12 shadow-2xl">
            <div className="text-center space-y-6">
              <div className="flex justify-center">
                <div className="p-6 bg-gradient-to-r from-gray-400 to-gray-500 rounded-3xl shadow-2xl">
              ...
              <div className="space-y-4">
                ...
                <p className="text-xl text-gray-600 dark:text-gray-400 max-w-md mx-auto">
                  The competition results haven't been announced yet. Click "Declare Winners" to set the final rankings.
                </p>
              </div>
              <div className="pt-4">
                <button
                  onClick={() => setEditMode(true)}
                  className="group relative px-10 py-5 bg-gradient-to-r from-purple-600 via-pink-600 to-red-500 
                           text-white font-bold text-xl rounded-2xl shadow-2xl hover:shadow-purple-500/25 
                           transform hover:scale-105 transition-all duration-300 overflow-hidden"
                >
                  <div
                    className="absolute inset-0 bg-gradient-to-r from-purple-500 via-pink-500 to-red-400 
