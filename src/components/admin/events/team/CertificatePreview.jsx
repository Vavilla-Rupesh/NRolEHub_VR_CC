                ...
                <div className="relative bg-white dark:bg-slate-800 rounded-2xl p-4 sm:p-6 shadow-2xl border border-white/20 dark:border-slate-700/50 overflow-hidden">
                  ...
                  <div className="relative overflow-auto max-h-[60vh] lg:max-h-[70vh]">
                    <div className="relative inline-block min-w-full">
                      ...
                      {/* Edit Mode Markers - Only dots with hover labels */}
                      {!previewMode && Object.entries(positions).map(([field, pos]) => (
                        <div
                          key={field}
                          style={getPreviewStyle(pos)}
                        ...
                        >
                          <div className="relative transform -translate-x-1/2 -translate-y-1/2">
                            {/* The marker dot */}
                            <div className={cn(
                              "w-4 h-4 rounded-full shadow-lg border-2 border-white relative transition-all duration-300 cursor-pointer",
                              selectedField === field 
                                ? "bg-gradient-to-r from-red-500 to-pink-500 scale-125"
                            ...
                            {hoveredField === field && (
                              <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 z-20">
                                <div className="bg-slate-800 dark:bg-slate-700 text-white text-xs font-medium px-3 py-1.5 rounded-lg shadow-lg whitespace-nowrap animate-fade-in">
                                  {fields[field]}
                                  {/* Tooltip arrow */}
                      ...
                      {previewMode && Object.entries(positions).map(([field, pos]) => {
                        ...
                        switch (field) {
                          ...
                          case 'date':
                            ...
                            break;
                          case 'certificateId':
                            content = isTeam ? '2024100501-0802-1000' : '2024100501-0802-1000';
                            className += 'text-sm sm:text-base text-slate-600 dark:text-slate-300';
                            break;
                          case 'rank':
                            content = '1st Place';
