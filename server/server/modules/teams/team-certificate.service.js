  ...
  try {
    ...
    for (const team of teams) {
      ...
      for (const member of team.TeamMembers) {
        ...
        console.log(`Generating certificate for Team: "${teamName}", Member: "${member.student.username}"`);
        ...
        // Ensure team name is not null/undefined
        const certificateBuffer = await overlayTextOnImage(
          ...
          teamName, // Team name - ensure it's not null
          {
